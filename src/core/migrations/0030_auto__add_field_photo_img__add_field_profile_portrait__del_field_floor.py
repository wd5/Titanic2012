...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.img'
        db.add_column('core_photo', 'img',
        ...
        # Deleting field 'Floor.scheme'
        db.delete_column('core_floor', 'scheme')

    def backwards(self, orm):
        # Deleting field 'Photo.img'
        db.delete_column('core_photo', 'img')
