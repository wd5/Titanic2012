...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_profile', 'room', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Room'], null=True, blank=True), keep_default=False)
