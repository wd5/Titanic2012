...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Dance'
        db.create_table('core_dance', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('scheme', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('music', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('video', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=100)),
        ))
        db.send_create_signal('core', ['Dance'])

    def backwards(self, orm):

        # Deleting model 'Dance'
        db.delete_table('core_dance')
