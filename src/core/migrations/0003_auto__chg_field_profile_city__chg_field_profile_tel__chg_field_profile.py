...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.tel'
        db.alter_column('core_profile', 'tel', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Profile.name'
        db.alter_column('core_profile', 'name', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Profile.age'
        db.alter_column('core_profile', 'age', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Profile.nick'
        db.alter_column('core_profile', 'nick', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.tel'
        db.alter_column('core_profile', 'tel', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Profile.name'
        db.alter_column('core_profile', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Profile.age'
        db.alter_column('core_profile', 'age', self.gf('django.db.models.fields.IntegerField')(default=''))

        # Changing field 'Profile.nick'
        db.alter_column('core_profile', 'nick', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'core.role': {
            'Meta': {'ordering': "['ticket_level', 'order']", 'object_name': 'Role'},
