...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Floor'
        db.create_table('core_floor', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'\u044d\u0442\u0430\u0436', max_length=200)),
        ...
        db.send_create_signal('core', ['Floor'])

    def backwards(self, orm):

        # Deleting model 'Floor'
        db.delete_table('core_floor')
