...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        floors = (('Осн. 1й этаж', 'i/floors/osn1.jpg', 10),
                  ('Осн. 2й этаж', 'i/floors/osn2.jpg', 20),
                  ('Гост. 1й этаж', 'i/floors/gost1.jpg', 30),
                  ('Гост. 2й этаж', 'i/floors/gost2.jpg', 40),
            )

        for floor in floors:
            orm.Floor.objects.create(title=floor[0], scheme=floor[1], order=floor[2])
