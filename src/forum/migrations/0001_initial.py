...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_thread', (
            ...
            ('base_comment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='base_comment', to=orm['forum.Comment'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_comment_date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
    ...
    models = {
        ...
        'forum.thread': {
            ...
            'base_comment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'base_comment'", 'to': "orm['forum.Comment']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
